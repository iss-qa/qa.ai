    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-brand/30 overflow-x-hidden">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32 flex flex-col items-center text-center">
        ...
        <p className="max-w-2xl text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed">
          ...
          testes em <strong className="text-foreground">Android</strong>, <strong className="text-foreground">iOS</strong> e <strong className="text-foreground">Web</strong> — sem escrever uma linha de código.
        </p>
        ...
        <div className="w-full max-w-4xl relative">
          ...
          <div className="relative bg-card border border-border rounded-2xl shadow-2xl overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-foreground/[0.02]">
              ...
              <span className="text-xs text-muted-foreground ml-2 font-mono">QAMind — Test Editor</span>
            </div>
            <div className="p-6 md:p-8 font-mono text-sm space-y-3">
              ...
              <div className="space-y-1.5 pl-7 text-xs">
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 1: OPEN_APP → WasteZero</p>
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 2: WAIT → 2000ms</p>
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 3: TAP → campo de email</p>
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 4: TYPE → isaias@gmail.com</p>
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 5: TAP → campo de senha</p>
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 6: TYPE → senha123</p>
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 7: TAP → Entrar</p>
                <p className="text-muted-foreground"><span className="text-green-400">✓</span> Step 8: ASSERT_TEXT → Dashboard</p>
              </div>
              <div className="h-px bg-border" />
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="group p-6 rounded-2xl bg-foreground/[0.02] border border-border hover:border-border transition-all duration-300 hover:bg-foreground/[0.04]">
      ...
      <section id="how-it-works" className="relative z-10 py-24 border-t border-border">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">De zero a testes automatizados executando em dispositivos reais.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="relative p-8 rounded-2xl bg-gradient-to-b from-foreground/[0.03] to-transparent border border-border">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-foreground/[0.02] border border-border text-center hover:border-brand/20 transition-colors">
      ...
      {/* Pricing */}
      <section id="pricing" className="relative z-10 py-24 border-t border-border bg-foreground/[0.01]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className={`p-8 rounded-2xl border relative ${plan.highlighted ? 'bg-gradient-to-b from-brand/10 to-transparent border-brand/30 shadow-[0_0_40px_rgba(74,144,217,0.1)]' : 'bg-foreground/[0.02] border-border'}`}>
                {plan.highlighted && (
