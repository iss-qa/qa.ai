...
export function ExecutionToast() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-80 bg-popover border border-border rounded-xl shadow-2xl p-4">
      <div className="flex items-center gap-2 mb-2">
        <Loader2 className="w-4 h-4 text-brand animate-spin" />
        <span className="text-sm font-semibold text-foreground">Executando teste</span>
      </div>
